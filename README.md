...
## Implementation
We provide you with a simplified API to get the list of activities and information about them. The API does not require any login. Whats important to us is that the app is smooth and that scrolling does not have any stuttering.

What we would like to see anyway is:
 - A project written Kotlin
 - some usage of [RxJava](https://github.com/ReactiveX/RxJava)
 - Read/write data to a persistent storage/DB
 - a MVP architecture with unit-test
